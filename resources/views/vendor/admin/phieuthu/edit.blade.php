...
<div class="themgoidieutri clearfix" style="background: #fff;">
    ...
    <form action="http://localhost/son/public/admin/phieu-thus/{{$order->id}}" method="POST" id="create-order-form">
            ...
            <div class="fields-group">
                ...
                <div class="col-md-12">
                    <div class="form-group clearfix">
                        ...
                        <div class="col-sm-8">
                            <div class="input-group">
                                ...
                                <input required="1" type="text" id="ma_phieuthu" name="ma_phieuthu" value="{{ old('orderCode', $order->ma_phieuthu) }}" class="form-control ten" placeholder="Input mã khách hàng">
                            </div>
                        </div>
                    </div>
                    <div class="form-group clearfix">
                        ...
                        <div class="col-sm-4 o_tron_hoten">
                            <input required="1" type="text" id="ho_ten" name="ho_ten1" value="{{ old('orderCode', $khach_hang->ho_ten) }}" class="form-control ho_ten" placeholder="Input Tên">
                        ...
                        <div class="col-sm-4">
                            <input required="1" type="text" id="dien_thoai" name="dien_thoai" value="{{ old('orderCode', $khach_hang->dien_thoai) }}" class="form-control dien_thoai" placeholder="SĐT">
                    ...
                    <div class="form-group clearfix">
                        ...
                        <div class="col-sm-4">
                            <input  type="text" id="ngay_sinh" name="ngay_sinh" value="{{ old('orderCode', $khach_hang->ngay_sinh) }}" class="form-control ngay_sinh" placeholder="Input Ngày sinh">
                        ...
                        <div class="col-sm-4">
                            <input  type="text" id="dia_chi" name="dia_chi" value="{{ old('orderCode', $khach_hang->dia_chi) }}" class="form-control dia_chi" placeholder="Địa Chi">
                        </div>
                    </div>
                    <div class="col-md-12" id="tron_goidt">
                        ...
                        <div id="details" style="display:none">
                            ...
                            <div class="detail" data-id="{{ $detail->id }}" data-tieu_de="{{ $detail->tieu_de }}" data-content="{{ $detail->content }}" data-gia="{{ $detail->gia_tien / $detail->soluong_goi }}" data-gia_tien="{{ $detail->gia_tien }}" data-soluong_goi="{{ $detail->soluong_goi }}"  style="display: none;"></div>
                            @endforeach
                        </div>
                    </div>
                    ...
                    <div class="form-group clearfix">
                        ...
                        <div class="col-sm-8">
                            <div class="input-group">
                                <span class="input-group-addon"><i class="fa fa-pencil fa-fw"></i></span>
                                <input  type="text" id="tien_thanhtoan" name="tien_thanhtoan" value="{{ old('orderCode', $order->tien_thanhtoan) }}" class="form-control ten" placeholder="Input mã khách hàng">
                            </div>
                        </div>
                    </div>
                    <div class="form-group clearfix">
                        ...
                        <div class="col-sm-8">
                            <div class="input-group">
                                <span class="input-group-addon"><i class="fa fa-pencil fa-fw"></i></span>
                                <input  type="text" id="tien_con" name="tien_con" value="{{ old('orderCode', $order->tien_con) }}" class="form-control tien_con" placeholder="Input mã khách hàng">
                            </div>
                        </div>
                    </div>
                    <div class="form-group clearfix">
                        ...
                        <div class="col-sm-8">
                            <div class="input-group">
                                <span class="input-group-addon"><i class="fa fa-pencil fa-fw"></i></span>
                                <input  type="text" id="ghi_chu" name="ghi_chu" value="{{ old('orderCode', $order->ghi_chu) }}" class="form-control ghi_chu" placeholder="Input mã khách hàng">
                            </div>
                        </div>
                    </div>
                </div>
        ...
        <div class="col-md-12">
            <div class="form-group" style="float: right">
                <input class="luu_pth btn btn-primary" type="submit" value="Lưu">
    ...
    function getds_gdt(){
        $('#details').find('.detail').each(function() {
            if($(this).attr('data-id') != ''){
                let de = {
                    'id' : $(this).attr('data-id'),
                                'ten' : $(this).attr('data-content'),
                                'gia' : $(this).attr('data-gia'),
                                'ten_goi' : $(this).attr('data-tieu_de'),
                                'soluong_goi': $(this).attr('data-soluong_goi'),
                                'thanh_tien': $(this).attr('data-gia_tien'),
                }
                ds_gdt.push(de);
            }
        });
