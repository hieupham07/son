    ...
    <div class="box-header with-border">
        ...
        <div class="box-tools">
            <div class="btn-group pull-right" style="margin-right: 5px">
                <a href="http://localhost/son/public/admin/goi-dieu-tris/" class="btn btn-sm btn-default"
                    title="List"><i class="fa fa-list"></i><span class="hidden-xs">&nbsp;List</span></a>
            </div>
        </div>
    </div>
                    ...
                    <div class="form-group clearfix">
                        ...
                        <div class="col-sm-8">
                            <div class="input-group">
                                ...
                                <input required="1" type="text" id="ten" name="ten"
                                    value="{{ old('orderCode', $order->ten) }}" class="form-control ten"
                                    placeholder="Input Tên">
                            </div>
                        </div>
                    </div>
                    <div class="form-group clearfix">
                        ...
                        <div class="col-sm-8">
                            <textarea name="mo_ta" class="form-control mo_ta" rows="5"
                                placeholder="Input Mô tả">{{ old('orderCode', $order->mo_ta) }}</textarea>
                        </div>
                    </div>
                    <div class="form-group clearfix">
                        ...
                        <div class="col-sm-8">
                            <div class="input-group">
                                <span class="input-group-addon"><i class="fa fa-pencil fa-fw"></i></span>
                                <input type="number" id="gia" name="gia" value="{{ old('orderCode', $order->gia) }}"
                                    class="form-control gia" placeholder="Input Giá">
                            </div>
                        </div>
                    </div>
                    <div class="form-group clearfix">
                        ...
                        <div class="col-sm-8">
                            <div class="input-group">
                                <span class="input-group-addon"><i class="fa fa-pencil fa-fw"></i></span>
                                <input type="number" id="giam_gia" name="giam_gia"
                                    value="{{ old('orderCode', $order->giam_gia) }}" class="form-control giam_gia"
                                    placeholder="Input Giá">
                            </div>
                        </div>
                    </div>
                    <div class="form-group clearfix">
                        ...
                        <div class="col-sm-8">
                            <div class="input-group">
                                <span class="input-group-addon"><i class="fa fa-pencil fa-fw"></i></span>
                                <input type="number" id="so_buoi" name="so_buoi"
                                    value="{{ old('orderCode', $order->so_buoi) }}" class="form-control so_buoi"
                                    placeholder="Input Số buổi">
                            </div>
                        </div>
                    </div>
                    <div class="form-group clearfix">
                        ...
                        <div class="col-sm-8">
                            <textarea name="ghi_chu" class="form-control ghi_chu" rows="5"
                                placeholder="Input Ghi chú">{{ old('orderCode', $order->ghi_chu) }}</textarea>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="form-group clearfix">
                    ...
                    <div class="col-sm-8">
                        <select name="vattu" class="form-control" id="vattu">
                            ...
                            <option value="{{ $loc->id }}" @if($loc->id == old('created_by')) selected
                                @endif>{{ $loc->ten}}</option>
                            @endforeach
                        </select>
                        <div id="ls_vt">
                            @foreach($vattu as $loc)
                            <div class="ls_vt" data-id="{{ $loc->id }}" data-name="{{ $loc->ten }}"
                        ...
                        <div id="vat_tu_goi_c">
                            ...
                            <div class="vt_c" data-id="{{ $dc->vattu_id }}" data-name="" data-sl="{{ $dc->so_luong }}"
                                style="display: none;"></div>
                            @endforeach
                        </div>
                    </div>
