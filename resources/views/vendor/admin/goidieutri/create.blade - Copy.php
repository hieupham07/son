<div class="row">
    <div class="col-md-12">
        <div class="box box-danger">
            <form action="{{ route("admin.quote.store") }}" method="POST" id="create-order-form">
                ...
                <div class="col-md-12">
                    ...
                    <div class="form-group col-md-6 col-lg-2 col-xs-12">
                        ...
                        <div class="clearfix">
                            <input placeholder="Mã đơn" name="orderCode" value="{{ old('orderCode') }}"
                                   id="orderCode" class="form-control" type="text">
                        </div>
                    </div>
                        ...
                        <div class="clearfix">
                            <select name="created_by" class="form-control" id="created_by">
                                ...
                                {{-- @foreach($users as $loc)
                                    <option value="{{ $loc->id }}" @if($loc->id == old('created_by')) selected @endif>{{ $loc->name}}</option>
                                @endforeach --}}
                            </select>
                        </div>
                    </div>
                ...
                <div class="col-md-12">
                    <div class="table-responsive">
                        @include('vendor.admin.quote._productTable')
                    </div>
                </div>
                <hr>
                <div class="col-md-12">
